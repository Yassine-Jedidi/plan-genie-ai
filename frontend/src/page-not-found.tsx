...
function MessageDisplay() {
  ...
  return (
    <div
      className={`absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100] transition-opacity duration-500 ${
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        <div className="flex gap-4 mt-8">
          <Button
            onClick={() => navigate(-1)}
            variant="outline"
            className="text-foreground border-foreground hover:bg-primary-foreground/70 transition-all duration-300 ease-in-out"
          >
            <svg
          ...
          <Button
            onClick={() => navigate("/")}
            className="bg-foreground text-background hover:bg-foreground/80 transition-all duration-300 ease-in-out"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
